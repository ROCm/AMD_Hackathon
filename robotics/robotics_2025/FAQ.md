...
3. Go through https://huggingface.co/docs/lerobot/main/en/il_robots if this is your first time using LeRobot and the SO101 Arm.
4. Learn to use Jupyter Notebook. We will assign an MI300X Virtual Machine (VM) to each team for training and for copying data between your local machine and the VM.
