#!/bin/bash
################################################################################
# Script: 08_upload_dataset_v8.sh
# Purpose: Upload trash_sorting_40ep_v8 (30 episodes) to HuggingFace Hub
# Usage:  ./scripts/08_upload_dataset_v8.sh
################################################################################
...
LOG_FILE="${SCRIPT_DIR}/logs/08_upload_dataset_v8_${TIMESTAMP}.log"
...
echo ""
echo "=============================================="
echo "  Upload Dataset v8 (30 episodes)"
echo "=============================================="
echo ""
log "Starting dataset upload (v8)..."
...
# Dataset configuration for v8
DATASET_PATH="${HOME}/so101_datasets/trash_sorting_40ep_v8"
DATASET_REPO_ID="${HF_USER}/trash_sorting_30ep"
